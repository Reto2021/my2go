...
export function FloatingPlaySlider({ onStreakDetailsOpen }: FloatingPlaySliderProps) {
  ...
  return (
    <>
      ...
      {/* Fixed bottom bar above navigation */}
      <div className="fixed bottom-[calc(4.5rem+env(safe-area-inset-bottom))] left-0 right-0 z-40 px-3 pb-2">
        <motion.div
          ...
          style={{
            boxShadow: '0 -4px 20px rgba(0,0,0,0.15), 0 4px 20px rgba(0,0,0,0.2)',
          }}
        >
          {/* Lock progress bar */}
          {isLocked && (
              ...
              >
                ...
                >
                  <div className="flex items-center gap-2 text-white/50">
                    <span className="text-sm font-medium">Slide für Bonus</span>
                    <motion.div
                      animate={{ x: [0, 5, 0] }}
