...
export function RadioPlayerBar({ onExpand, onStreakDetailsOpen }: RadioPlayerBarProps) {
  ...
  return (
    <>
      ...
      {/* Fixed bar above BottomNav - 5rem nav + 0.5rem spacing */}
      <div className="fixed bottom-[calc(5.5rem+env(safe-area-inset-bottom))] left-1/2 -translate-x-1/2 z-40 w-full max-w-md px-3 pointer-events-none">
